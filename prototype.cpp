    ...
    if (choice1 == 1) {
        ...
        if (choice2 == 1 ){
            ...
            if (choice3 == 1) {
                ...
                if (choice4 == 2){
                    cout << "You decide to keep running but you are not fast enough...\n" << "The vampire catches up to you and makes you his late night snack, all you hear in the cold, dark night are your own screams, you died...\n";
                }
            }if (choice3 == 2){
                srand(time(0));
                ...
                if (damage < 60 ){
                    ...
                    cout << "The hit didn't do enough damage, the vampire grabs you and makes you his late night snack. All you can hear in the cold, dark night are your own screams, you died... \n";
                }else{
